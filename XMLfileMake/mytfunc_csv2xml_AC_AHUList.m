...
for iAHU = 11:size(ahuListDataCell,1)
    ...
    if isempty(ahuListDataCell{iAHU,5}) == 0
        if strcmp(ahuListDataCell(iAHU,5),'空調機') || strcmp(ahuListDataCell(iAHU,5),'AHU') || ...
                strcmp(ahuListDataCell(iAHU,5),'ＡＨＵ') || strcmp(ahuListDataCell(iAHU,5),'空気調和機') || strcmp(ahuListDataCell(iAHU,5),'外気処理空調機') 
            xmldata.AirConditioningSystem.AirHandlingUnit(iAHU-10).ATTRIBUTE.Type = 'AHU';
        elseif strcmp(ahuListDataCell(iAHU,5),'FCU') || strcmp(ahuListDataCell(iAHU,5),'ＦＣＵ')
            xmldata.AirConditioningSystem.AirHandlingUnit(iAHU-10).ATTRIBUTE.Type = 'FCU';
        elseif strcmp(ahuListDataCell(iAHU,5),'室内機') || strcmp(ahuListDataCell(iAHU,5),'UNIT') || strcmp(ahuListDataCell(iAHU,5),'ＵＮＩＴ')
